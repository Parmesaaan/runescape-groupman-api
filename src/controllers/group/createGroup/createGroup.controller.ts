...
export const groupCreateController: RequestHandler = async(req: Request, res: Response) => {
    ...
    return res.status(HttpStatusCode.Created).send({message: `Group created with name ${request.name}`})
}