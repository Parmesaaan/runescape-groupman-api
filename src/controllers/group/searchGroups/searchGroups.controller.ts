...
import { SearchGroupsDto } from './searchGroups.dto'
import { GroupService } from '../../../services'
import { isOpFailure } from '../../../utils'
import { HttpStatusCode } from 'axios'

export const searchGroupsController: RequestHandler = async (req: Request, res: Response) => {
  const request: SearchGroupsDto = req.body as unknown as SearchGroupsDto
