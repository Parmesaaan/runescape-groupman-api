...
const requestAttributeValidator = (attribute: 'body' | 'params' | 'query' | 'mergedData') => (dto: ClassConstructor<object>): RequestHandler => async(req: Request, response: Response, next: NextFunction): Promise<void> => {
